...
from problem import NLPProblem, DataModule, LightningRecurrent
from evolution import Optimizer


def parse_args():
    parser = argparse.ArgumentParser()
    parser = NLPProblem.add_arguments(parser)
    ...
    parser.add_argument("--chromosome", type=str, default="")
